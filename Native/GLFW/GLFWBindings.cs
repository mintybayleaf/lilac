...
public unsafe class GLFWBindings
{
    #region Constants
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void GLFWwindowposCallback(IntPtr window, int posx, int posy);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void GLFWcursorposCallback(IntPtr window, double mousex, double mousey);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void GLFWcharmodsCallback(IntPtr window, int codepoint, int mods);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void GLFWdropCallback(IntPtr window, int count, string[] paths);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void GLFWmonitorCallback(IntPtr window, int monitorevent);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void GLFWjoystickCallback(int jid, int ev);
    ...
    [DllImport(Platform.GLFWLibrary, CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport(Platform.GLFWLibrary, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
    ...
    [DllImport(Platform.GLFWLibrary, CallingConvention = CallingConvention.Cdecl)]
    public static extern GLFWmonitorCallback glfwSetMonitorCallback(GLFWmonitorCallback callback);

    [DllImport(Platform.GLFWLibrary, CallingConvention = CallingConvention.Cdecl)]
    public static extern GLFWwindowposCallback glfwSetWindowPosCallback(IntPtr window, GLFWwindowposCallback callback);

    [DllImport(Platform.GLFWLibrary, CallingConvention = CallingConvention.Cdecl)]
    public static extern GLFWwindowsizeCallback glfwSetWindowSizeCallback(IntPtr window, GLFWwindowsizeCallback callback);

    [DllImport(Platform.GLFWLibrary, CallingConvention = CallingConvention.Cdecl)]
    public static extern GLFWwindowcloseCallback glfwSetWindowCloseCallback(IntPtr window, GLFWwindowcloseCallback callback);

    [DllImport(Platform.GLFWLibrary, CallingConvention = CallingConvention.Cdecl)]
    public static extern GLFWwindowrefreshCallback glfwSetWindowRefreshCallback(IntPtr window, GLFWwindowrefreshCallback callback);

    [DllImport(Platform.GLFWLibrary, CallingConvention = CallingConvention.Cdecl)]
    public static extern GLFWwindowfocusCallback glfwSetWindowFocusCallback(IntPtr window, GLFWwindowfocusCallback callback);

    [DllImport(Platform.GLFWLibrary, CallingConvention = CallingConvention.Cdecl)]
    public static extern GLFWwindowiconifyCallback glfwSetWindowIconifyCallback(IntPtr window, GLFWwindowiconifyCallback callback);

    [DllImport(Platform.GLFWLibrary, CallingConvention = CallingConvention.Cdecl)]
    public static extern GLFWframebuffersizeCallback glfwSetFramebufferSizeCallback(IntPtr window, GLFWframebuffersizeCallback callback);

    [DllImport(Platform.GLFWLibrary, CallingConvention = CallingConvention.Cdecl)]
    public static extern GLFWkeyCallback glfwSetKeyCallback(IntPtr window, GLFWkeyCallback callback);

    [DllImport(Platform.GLFWLibrary, CallingConvention = CallingConvention.Cdecl)]
    public static extern GLFWcharCallback glfwSetCharCallback(IntPtr window, GLFWcharCallback callback);

    [DllImport(Platform.GLFWLibrary, CallingConvention = CallingConvention.Cdecl)]
    public static extern GLFWcharmodsCallback glfwSetCharModsCallback(IntPtr window, GLFWcharmodsCallback callback);

    [DllImport(Platform.GLFWLibrary, CallingConvention = CallingConvention.Cdecl)]
    public static extern GLFWmousebuttonCallback glfwSetMouseButtonCallback(IntPtr window, GLFWmousebuttonCallback callback);

    [DllImport(Platform.GLFWLibrary, CallingConvention = CallingConvention.Cdecl)]
    public static extern GLFWcursorposCallback glfwSetCursorPosCallback(IntPtr window, GLFWcursorposCallback callback);

    [DllImport(Platform.GLFWLibrary, CallingConvention = CallingConvention.Cdecl)]
    public static extern GLFWcursorenterCallback glfwSetCursorEnterCallback(IntPtr window, GLFWcursorenterCallback callback);

    [DllImport(Platform.GLFWLibrary, CallingConvention = CallingConvention.Cdecl)]
    public static extern GLFWscrollCallback glfwSetScrollCallback(IntPtr window, GLFWscrollCallback callback);

    [DllImport(Platform.GLFWLibrary, CallingConvention = CallingConvention.Cdecl)]
    public static extern GLFWdropCallback glfwSetDropCallback(IntPtr window, GLFWdropCallback callback);

    [DllImport(Platform.GLFWLibrary, CallingConvention = CallingConvention.Cdecl)]
    public static extern GLFWjoystickCallback glfwSetJoystickCallback(GLFWjoystickCallback callback);
